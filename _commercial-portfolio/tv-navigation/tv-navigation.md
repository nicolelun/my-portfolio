...
<div class="text-col">
	...
	<table class="proj-details">
		<tr><td class="proj-details__label">My Roles:</td> <td class="proj-details__data">Information Architect, Designer &amp; Frontend Developer</td></tr>
...
<div class="text-col">
	...
	<h2>Epilogue</h2>
	<p>After these efforts to improve information scent, customer satisfication in key categories increased by 30%. <!-- With thousands of categories and more added very month, this project evolved into ongoing maintenance.  -->In parallel, I continue to spearhead efforts to streamline the overall taxonomy, collaborating with the merchandisers to identify categories to retire, move, merge, rename, or canonicalize for SEO. With thousands of categories, this is an ongoing project, but one that will drive even bigger benefits for usability and ultimately sales.<!-- which will drive even bigger benefits for usability, customer satisficaton, and ultimately revenue. --></p>
</div>