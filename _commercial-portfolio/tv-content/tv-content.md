...
<div class="text-col">
	...
	<h2>Epilogue</h2>
	<p>With limited resources for this self-driven initiative, I enhanced the e-commerce site and enabled it to present a fuller image of the brand. <!-- However, I would have liked to measure the impact on SEO, traffic, and revenue, the main KPIs. --> Along with other SEO improvements, such as sitemaps and metadata, this contributed to increases in natural search visits by over 150%, orders by over 45%, and revenue by over 90%. Ultimately, I believe that the biggest benefit to customers and the business would come from refreshing and migrating the articles. With analyses from an SEO agency, the e-commerce team developed a business case to advocate for this long-term, future effort.</p> 
</div>
